...
public class CreateColorDialog extends Dialog{
    /**
     * 上下文对象 *
     */
    Activity context;
    ...
    public CreateColorDialog(Activity context) {
        super(context);
        this.context = context;
    }

    public CreateColorDialog(Activity context, int themeResId,MultiSelector.OnSelectListener clickListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 指定布局
        this.setContentView(R.layout.simple_color_select);
        ...
        multiSelector = (MultiSelector) findViewById(R.id.multi_selector);
