package com.example.chen.wsscapp.Util.historyfile.controller;
...
import com.example.chen.wsscapp.Util.SelectedHistoryFileListener;
import com.example.chen.wsscapp.Util.ViewPagerAdapter;
import com.example.chen.wsscapp.Util.historyfile.activity.HistoryFileActivity;
import com.example.chen.wsscapp.Util.historyfile.fragment.AudioFileFragment;
import com.example.chen.wsscapp.Util.historyfile.fragment.DocumentFileFragment;
import com.example.chen.wsscapp.Util.historyfile.fragment.ImageFileFragment;
import com.example.chen.wsscapp.Util.historyfile.fragment.OtherFileFragment;
import com.example.chen.wsscapp.Util.historyfile.fragment.VideoFileFragment;
import com.example.chen.wsscapp.Util.historyfile.view.HistoryFileView;
        ...
        switch (view.getId()) {
            ...
            case R.id.delete_file_btn:
                ...
                for (Integer id : idMap.keySet()) {
                    ...
                    MyApplication.ids.add(conversation.getMessage(idMap.get(id)));
