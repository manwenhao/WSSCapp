...
import com.example.chen.wsscapp.Util.historyfile.adapter.DocumentFileAdapter;
import com.example.chen.wsscapp.Util.historyfile.controller.HistoryFileController;
import com.example.chen.wsscapp.View.StickyListHeadersListView;
...
public class DocumentFileFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = LayoutInflater.from(mContext).inflate(R.layout.document_file,
                (ViewGroup) mContext.findViewById(R.id.chat_father), false);
