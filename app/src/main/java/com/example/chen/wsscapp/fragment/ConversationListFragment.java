...
import com.example.chen.wsscapp.Util.ConversationListController;
...
public class ConversationListFragment extends BaseFragment {
   ...
   // private View mMenuView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = layoutInflater.inflate(R.layout.fragment_msg,
                (ViewGroup) getActivity().findViewById(R.id.chat_father), false);
