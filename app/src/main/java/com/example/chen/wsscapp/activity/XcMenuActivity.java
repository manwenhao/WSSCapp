...
public class XcMenuActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = "XcMenuActivity";
    ...
    private void uploadShopInfo(final List<File> files) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final okhttp3.Request request = new okhttp3.Request.Builder()
                        .url("http://106.14.145.208/ShopMall/UploadShopXCPhotos")
                        .post(requestBody)
                        .build();
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(XcMenuActivity.this,"上传超时失败",Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        if(resp.equals("ok")){
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(XcMenuActivity.this,"上传成功",Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
                                }
                            });
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(XcMenuActivity.this,"上传失败",Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
                                }
                            });
